...
public class KafkaConfig {
	...
	private Map<String , Object> basicProperties(){
		...
		basicProperties.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
		basicProperties.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, TabStockPriceInfoDeserializer.class);
