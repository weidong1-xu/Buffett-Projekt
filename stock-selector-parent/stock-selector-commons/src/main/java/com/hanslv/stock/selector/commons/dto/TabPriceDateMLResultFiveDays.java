...
public class TabPriceDateMLResultFiveDays {
	...
	@ApiModelProperty(value="第一天收盘价" , name="endPriceA" , required=true , position=2)
	private String endPriceA;
	@ApiModelProperty(value="第二天收盘价" , name="endPriceB" , required=true , position=3)
	private String endPriceB;
	@ApiModelProperty(value="第三天收盘价" , name="endPriceC" , required=true , position=4)
	private String endPriceC;
	@ApiModelProperty(value="第四天收盘价" , name="endPriceD" , required=true , position=5)
	private String endPriceD;
	@ApiModelProperty(value="第五天收盘价" , name="endPriceE" , required=true , position=6)
