 ...
 */
@Deprecated
public class BasicKafkaUtil<K , V> {
	Logger logger = Logger.getLogger(BasicKafkaUtil.class);
	 ...
	 * @param propPath
	 */
	public BasicKafkaUtil(String propPath) {
		/*
		 * 加载当前实例的配置文件
		 */
		currentProp = new Properties();
		try(InputStream inputStream = BasicKafkaUtil.class.getResourceAsStream(propPath);
